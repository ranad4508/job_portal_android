...
// Ajax Call for Tutor Login Verification
function checkTutorLogin() {
    var tutorLogEmail = $("#email").val();
    var tutorLogPass = $("#pass").val();
    $.ajax({
